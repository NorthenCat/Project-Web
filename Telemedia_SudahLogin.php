...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <a class="nav-link text-white" href="#">Home</a>
        ...
        <a href="Keranjang.php" class="nav-link text-white font-weight-normal"><i class="fas fa-shopping-cart"></i> Keranjang</a>
    </ul>
  ...
  <div class="container">
    <h1 class="display-4">Selamat Datang Di Website Kami, <?php echo $_SESSION['username']; ?> !</h1>
      <hr class="my-4">
      ...
      <div class="col-md-3">
        <div class="card" style="height: 34rem">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-justify"><?php echo $row ['deskripsi_produk']; ?></p> 
          </div>
          <a class="btn btn-primary" class="form-control" href="proses_keranjang.php?barang=<?php echo $row['id_produk']; ?>">Buy</a>
        </div>
      </div>
    <?php } } ?>
  </div>
